...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-header">
                ...
                <h1 class="login-title typewriter">ACESSO RESTRITO</h1>
                <p class="login-subtitle">Área exclusiva para membros da equipe</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="login-form">
                ...
                <div class="form-group">
                    ...
                    <input id="email" class="form-control" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" placeholder="seu@email.com">
                    @if($errors->get('email'))
                ...
                <div class="login-actions">
                    <button type="submit" class="btn-login">
                        <i class="fas fa-sign-in-alt"></i> {{ __('Acessar') }}
                    </button>
                    
                    @if (Route::has('password.request'))
                    <a class="forgot-password" href="{{ route('password.request') }}">
                        <i class="fas fa-key"></i> {{ __('Esqueceu a senha?') }}
                    </a>
                    @endif
                </div>
            </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-foco no campo de email se houver erro
